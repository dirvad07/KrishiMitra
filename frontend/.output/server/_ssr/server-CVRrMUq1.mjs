...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-CVRrMUq1.js
var server_CVRrMUq1_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CGQDRoUA.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C0-HOVyl.mjs").then((n) => n.t),
...
//#endregion
export { createServerEntry, server_default as default, createMiddleware as n, server_CVRrMUq1_exports as t };
